...
6. [Диаграмма последовательностей (Добавление новой сделки в торговый журнал вручную через веб-интерфейс.)](#диаграмма-последовательностей).
7. [Модель БД](#модель-бд).
8. [Анализ принципов разработки](#анализ-принципов-разработки).
...
Добавление новой сделки в торговый журнал вручную через веб-интерфейс.
```plantUML
@startuml
